...
export interface RevealCardProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Optional override — clip-path string for the resting (closed) state */
  startClip?: string;
  /** Optional override — clip-path string for the revealed (open) state */
  expandClip?: string;
}
  ...
  (
    {
      ...
      startClip = "circle(50px at 64px 64px)",
      expandClip = "circle(160% at 64px 64px)",
      className,
      ...rest
    },
    ref
