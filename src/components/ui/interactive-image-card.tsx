...
/**
 * Props for the InteractiveImageCard component.
 */
export interface InteractiveImageCardProps {
  /** The main title for the card. */
  title: string;
  /** A subtitle or location label. */
  subtitle: string;
  /** The URL for the background image. */
  imageUrl: string;
  /** The text for the primary action button. */
  actionText: string;
  /** The destination URL for the top-right link and action button. */
  href: string;
...
/**
 * InteractiveImageCard — a responsive 3D-tilt card with a background image,
 * glass-morphism CTA, and arrow link in the top-right. Mouse movement drives
 * the tilt via framer-motion springs; children get translateZ depth layering.
 */
export const InteractiveImageCard = React.forwardRef<
  HTMLDivElement,
